...
router.post('/buckets', async (req, res, next) => {
  ...
  try {
    ...
    // [BucketsApi](https://github.com/Autodesk-Forge/forge-api-nodejs-client/blob/master/docs/BucketsApi.md#createBucket).
...
// POST /api/forge/oss/delbucket - deletes a bucket.
// Request body must be a valid JSON in the form of 
// { "bucketKey": "<bucket_name>" }.
router.post('/delbucket', async (req, res, next) => {
  try {
    // Delete a bucket using 
    // [BucketsApi](https://github.com/Autodesk-Forge/forge-api-nodejs-client/blob/HEAD/docs/BucketsApi.md#deleteBucket).
    ...
    console.log('go to delete bucket with req '+ 
      JSON.stringify(req, getCircularReplacer()));
    */
    // console.log('go to delete bucket using BucketsApi');
    // console.log('req.oauth_client = ' + JSON.stringify(req.oauth_client));
    // console.log('req.oauth_token = ' + JSON.stringify(req.oauth_token));
...
router.post('/objects', multer({ dest: 'uploads/' }).single('fileToUpload'), async (req, res, next) => {
  fs.readFile(req.file.path, async (err, data) => {
    ...
    try {
      // Upload an object to bucket using 
      // [ObjectsApi](https://github.com/Autodesk-Forge/forge-api-nodejs-client/blob/master/docs/ObjectsApi.md#uploadObject).
